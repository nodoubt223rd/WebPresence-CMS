...
namespace WebPresence.Core.Linq
{
    ...
    {
        public static IQueryable<TElement> ApplyOrder<TElement>(this IQueryable<TElement> source, IEnumerable<KeyValuePair<LambdaExpression, OrderType>> orders)
        {
        ...
        public static IEnumerable<TElement> ApplyOrder<TElement>(this IEnumerable<TElement> source, IEnumerable<KeyValuePair<LambdaExpression, OrderType>> orders)
        {
            foreach (KeyValuePair<LambdaExpression, OrderType> order in orders)
            {
