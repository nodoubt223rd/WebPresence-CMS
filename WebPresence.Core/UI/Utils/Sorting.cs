...
namespace WebPresence.Core.UI.Utils
{
    internal static class Sorting
    {
        internal static int[] Compact(int[] x, int emptySymbol)
        {
            int freePlace = 0;
        ...
        internal static int[] InvertPermutations(int[] perm)
        {
            int max = perm.Max();
        ...
        internal static int[] GetPermutation(string permutationString)
        {
